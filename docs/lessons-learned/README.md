...
| [a-clean-worktree-is-not-proof-a-resolution-kept-the-work.md](./a-clean-worktree-is-not-proof-a-resolution-kept-the-work.md) | An unmerged-entries probe cannot tell "resolved and kept" from "discarded"; a finished operation must verify the work is present | 2026-08-07 |
