...
| [stash-apply-refuses-dirty-overlap-without-markers.md](./stash-apply-refuses-dirty-overlap-without-markers.md) | Dirty overlap makes stash apply hard-refuse with no markers; park, reset, apply, stage, then reapply | 2026-08-11 |
